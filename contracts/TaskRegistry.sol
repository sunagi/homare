...
contract TaskRegistry is Ownable, ReentrancyGuard {
    ...
    struct Task {
        ...
        address rewardToken; // USDC address
    ...
    constructor(address _verificationOracle, address _payoutSplitter) {
     ...
     * @param _rewardAmount Reward amount in USDC
    ...
    function createTask(
        ...
        tasks[taskId] = Task({
            ...
            rewardToken: address(0), // USDC address will be set
